...
export default function NewCarPage() {
  ...
  const handleSubmit = (e) => {
    ...
    createCar(payload, {
      ...
      onError: (err) => {
        setErrorMsg(err?.response?.data?.message || "Avtomobilni qo'shishda xatolik yuz berdi.");
      },
    });
  };
    ...
    <div className="dashboard-shell">
      ...
      <main className={`dashboard-content ${sidebarOpen ? "sidebar-expanded" : "sidebar-collapsed"}`}>
        <header className="dash-header mb-6">
          ...
          <h1 className="dash-title">Yangi Avtomobil</h1>
          <p className="dash-subtitle">Katalog uchun yangi avtomobil yaratish formasi.</p>
        </header>
